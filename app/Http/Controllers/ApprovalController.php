  ...
  public function get_datatable()
  {
      ...
      return Datatables::eloquent($approval)
          ...
          ->addColumn('provinsi', function ($approval) {
              return  $approval->kelurahan && $approval->kelurahan->kecamatan && $approval->kelurahan->kecamatan->kota && $approval->kelurahan->kecamatan->kota->provinsi && $approval->kelurahan->kecamatan->kota->provinsi->nama ? $approval->kelurahan->kecamatan->kota->provinsi->nama : 'Undefined';
          })
          ->addColumn('kota', function ($approval) {
              return  $approval->kelurahan && $approval->kelurahan->kecamatan && $approval->kelurahan->kecamatan->kota && $approval->kelurahan->kecamatan->kota->nama ? $approval->kelurahan->kecamatan->kota->nama : 'Undefined';
          })
