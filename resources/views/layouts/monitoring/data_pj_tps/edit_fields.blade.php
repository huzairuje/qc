    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-line">
                ...
                {{ Form::text('alamat', $korsak_tps->alamat,null, ['class' => 'form-control','placeholder' => 'Isi Alamat']) }}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-line">
                ...
                {{ Form::text('foto', $korsak_tps->foto,null, ['class' => 'form-control','placeholder' => 'pilih foto saksi']) }}
            </div>
        </div>
    </div>
</div>
