            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="container">
                        <div class="body">
                            <div class="row clearfix">
                                {!! Form::model($user, ['route' => ['monitoring.dataadminkota.update', $user->id], 'files' => 'true', 'method' => 'patch']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-line">
                                                ...
                                                {{ Form::text('alamat', $data_kota->alamat,null, ['class' => 'form-control','placeholder' => 'Isi Alamat']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-line">
                                                ...
                                                {{ Form::text('foto', $data_kota->foto,null, ['class' => 'form-control','placeholder' => 'pilih foto saksi']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready( function() {
        ...
        var _url = '{{ route('monitoring.dataadminkota.ajax') }}';
